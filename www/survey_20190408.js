...
var  apipath_base_photo_dm ='http://w02.yeapps.com/ipi/syncmobile_417_new_ibn_newtest_tour/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
...
function page_pending(){
	...
	$.ajax(localStorage.base_url+'tourPending?cid='+localStorage.cid+'&rep_id='+localStorage.user_id+'&rep_pass='+localStorage.user_pass+'&synccode='+localStorage.synccode,{
			...
			if (localStorage.user_type=='sup'){
				var pShow=localStorage.path_value_tour+"repPendingCancel_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass
				var linkPath="window.open('"+pShow	+"', '_system');"
				//alert (linkPath)
			...
			$.afui.loadContent("#page_tour_pending",true,true,'right');	 
		var pShow1=localStorage.path_value_tour+"teamShow_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass
		var linkPath="window.open('"+pShow1	+"&monthPass=This', '_system');"
